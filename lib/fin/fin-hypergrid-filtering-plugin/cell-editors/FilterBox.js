...
var ComboBox = require('fin-hypergrid-combobox-cell-editor');
var prototype = ComboBox.parent('CellEditor').prototype;
...
var FilterBox = ComboBox.extend('FilterBox', {
    ...
    initialize: function() {
        ...
        var root = this.grid.behavior.dataModel.filter,
    ...
    modes: [
        {
            ...
            appendOptions: function(dropdown) {
                if (!dropdown.length) {
                    ...
                    var filter = this.grid.behavior.dataModel.filter,
                        opMenuGroups = filter.opMenuGroups;
    ...
    keyup: function(event) {
        if (
            !prototype.keyup.call(this, event) &&
    ...
    stopEditing: function(feedbackCount) {
        var result = prototype.stopEditing.call(this, feedbackCount);
