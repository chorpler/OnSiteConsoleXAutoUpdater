import { AfterViewInit, Directive, DoCheck, ElementRef, forwardRef                      } from "@angular/core"              ;
import { HostListener, Inject, KeyValueDiffer, KeyValueDiffers, Input, OnInit, Optional } from "@angular/core"              ;
import { ControlValueAccessor, NG_VALUE_ACCESSOR                                        } from "@angular/forms"             ;
import { CurrencyMaskConfig, CURRENCY_MASK_CONFIG                                       } from "./ngx-currency-mask.config" ;
