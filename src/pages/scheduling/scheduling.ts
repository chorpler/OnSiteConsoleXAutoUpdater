...
export class SchedulingPage {
  ...
  public get prefs()     : any {return SchedulingPage.PREFS;}                   ;
  ...
  constructor(
    ...
    public zone   : NgZone           , public db       : DBService         ,
    public server : ServerService    , public auth     : AuthService       ,
    public alert  : AlertService     , public modalCtrl: ModalController   ,
    public data   : OSData           , public pdf      : PDFService        ,
    public popCtrl: PopoverController, public keyService: KeyCommandService,
    public notify : NotifyService    , public appComponent:OnSiteConsoleX  ,
  ) {
      this.doc                          = {}                         ;
  ...
  public updateTechSettings(tech:Employee, site:Jobsite, rotation:string, shiftType:string) {
    ...
    //   tech.shiftLength = 0    ;
    // } else {
    let jobsite = site ? site : this.unassignedSite;
    ...
    let hours        = site.hoursList[rotation][shiftType][0]                          ;
