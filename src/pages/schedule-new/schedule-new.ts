...
import { Schedule, Employee, Jobsite                         } from '../../domain/domain-classes'    ;
...
export class ScheduleNewPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public viewCtrl:ViewController, public data:OSData, public alert:AlertService) {
    window['onsiteschedulenew'] = this;
  }

  ionViewDidLoad() {
    Log.l('ionViewDidLoad ScheduleNewPage');
    if(this.navParams.get('schedules') !== undefined) { this.schedules = this.navParams.get('schedules'); }
