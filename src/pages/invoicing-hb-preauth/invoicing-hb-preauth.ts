...
import { Log, moment, Moment, oo, XLSX, SaveAs, s2ab,                       } from '../../config/config.functions'                      ;
import { Report, Invoice, Jobsite, Employee, Shift, PayrollPeriod, PreAuth, } from '../../domain/domain-classes'                        ;
import { AlertService                                                       } from '../../providers/alert-service'                      ;
import { DBService                                                          } from '../../providers/db-service'                         ;
import { ServerService                                                      } from '../../providers/server-service'                     ;
import { OSData                                                             } from '../../providers/data-service'                       ;
import { NotifyService                                                      } from '../../providers/notify-service'                     ;
import { Dropdown, SelectItem, MenuItem, TieredMenu, MultiSelect,           } from 'primeng/primeng'                                    ;
...
export class HBPreauthPage implements AfterViewInit {
  @ViewChild('ionContentElement') ionContentElement:ElementRef;
  @ViewChild('menubarTieredMenu') menubarTieredMenu:TieredMenu;
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public zone:NgZone, public db:DBService, public server:ServerService, public alert:AlertService, public data:OSData, public notify:NotifyService, public loader:LoaderService) {
    window['onsitehbpreauthpage'] = this;
  }

  ngAfterViewInit() {
    Log.l("HBPreauthPage: ngAfterViewInit() fired");

  }

  ionViewDidLoad() {
    Log.l("HBPreauthPage: ionViewDidLoad() fired");
  ...
  public generatePreauthGrid(rprts?:Array<Report>) {
    let grid = [];
  ...
  public parameterChange() {
    ...
    this.reports = this.allReports.filter((a: Report) => {
      ...
      return date === dA && a.matchesSite(site);
    }).sort(this.sortReports);
  }

  public getReports(shift:Shift, site:Jobsite) {
