...
export const _compareTechAndSite = (tech:Employee, site:Jobsite) => {
...
export class EmployeePage implements OnInit {
  ...
  onSubmit() {
    ...
    if(!formInput.avatarName) {
      ...
      this.notify.addError("DUPLICATE USER", "The username field cannot be left blank.", 6000);
      ...
      this.notify.addError("DUPLICATE USER", "Another user already has that username.", 6000);
      setTimeout(() => {
