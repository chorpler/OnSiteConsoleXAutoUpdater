...
@IonicPage({ name: 'Schedule Choose' })
@Component({
  selector: 'page-schedule-choose',
  templateUrl: 'schedule-choose.html',
})
export class ScheduleChoosePage {
  public title       : string                          ="Schedule Choose"   ;
  public static PREFS: any                             =new Preferences()   ;
  public get prefs() { return ScheduleChoosePage.PREFS ;                  } ;
