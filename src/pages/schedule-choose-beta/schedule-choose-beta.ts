...
@IonicPage({ name: 'Schedule Choose Beta' })
@Component({
  selector: 'page-schedule-choose-beta',
  templateUrl: 'schedule-choose-beta.html',
})
export class ScheduleChooseBetaPage {
  @ViewChild('calendarComponent') calendarComponent:CalendarMonthViewComponent;
  public title       : string                          ="Schedule Choose"   ;
  public static PREFS: any                             =new Preferences()   ;
  public get prefs() { return ScheduleChooseBetaPage.PREFS ;                  } ;
