...
// export const testSort = function(a:Employee,b:Employee) {
//   Log.l(this);
//   return 1;
// }
...
@IonicPage({name: "DPS Daily Summary"})
@Component({
  selector: 'page-dps-daily-summary',
  templateUrl: 'dps-daily-summary.html',
})
export class DPSDailySummaryPage {
  ...
  ionViewDidLoad() {
    Log.l('ionViewDidLoad DPSDailySummaryPage');
  ...
  public runWhenReady() {
    ...
    if(eperiod && eperiod.size) {
      ...
      eperiod = this.data.createEmployeePeriodMap();
      this.ePeriod = eperiod;
      this.createShiftMap();
      this.createDataGrid();
      this.title = `DPS Daily Summary (${this.summaryDate.format("MMM DD YYYY")}) (${this.calcMode})`;
  ...
  public createDataGrid() {
    ...
    for(let site of sites) {
      ...
      for(let tech of techs) {
        ...
        let billedHours = shift.getNormalHours();
